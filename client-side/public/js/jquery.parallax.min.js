                ...
                function t(e, o) {
                    ...
                    if (
                        ...
                        o.src &&
                            ...
                            n.css(
                                "background",
                                'url("' + o.src + '") ' + o.pos + "/cover"
                            );
                    else {
                        o.scrollingSelector &&
                            (t.scrollingElement = (0, a.default)(
                                o.scrollingSelector
                            )[0]),
                            t.isSet || t.init(),
                            t.iList.push(this);
                                ...
                                value: function () {
                                    ...
                                    if (
                                        ...
                                        (o.boxWidth = e.outerWidth()),
                                            (o.boxHeight =
                                                e.outerHeight() + 2 * o.bleed),
                                            (o.boxOffsetTop =
                                                e.offset().top - o.bleed),
                                            (o.boxOffsetLeft = e.offset().left),
                                            (o.boxOffsetBottom =
                                                o.boxOffsetTop + o.boxHeight);
                                        var n = t.wH,
                                            s = t.dH,
                                ...
                                value: function () {
                                    ...
                                    function o() {
                                        ...
                                        (t.sT = Math.max(0, Math.min(o, e))),
                                            (t.sL = Math.max(
                                                0,
                                                Math.min(i, n.scrollLeft())
                                            )),
                                            (t.overScroll = Math.max(
                                                e - o,
                                                Math.min(e, 0)
                                            ));
                                    }
                                    if (!t.isSet) {
                                        var i = (0, a.default)(
                                                t.scrollingElement || document
                                            ),
                                            r = (0, a.default)(window),
                                            n = (0, a.default)(
                                                t.scrollingElement || window
                                            );
                                        r.on(
                                            "resize.px.parallax load.px.parallax",
                                            function () {
                                                e(), t.update(!0);
                                            }
                                        ),
